...
'Leucoderma': [
    'spots on the body',
    'patches spreading to the whole body',
    'graying of scalp hair',
    'grey hair',
    'graying of eyelashes',
],

'Leucorrhea': [
    'presence of white discharge in undergarments',
    'excess irritation',
    'inflammation in genital areas',
    'stomach ache',
    'pain in the stomach and itching sensation with discharge',
    'lethargy',
...
'Leukocytoclastic Vasculitis': [
    ...
    'palpable purpura (red to purple in color)',
    'eruptions like papules and pustules',
    'redness',
    'burning sensation',
    'localized pain',
    'malaise',
...
'Linear Morphea': [
    'purple or red colored patches over the skin (arms or legs)',
    'patches may develop with a lighter or white-colored center',
    'hard skin',
    'dry skin',
    'shiny skin',
    'thickened skin',
...
# Diseases starting with "M"
    ...
    'Trigeminal Neuralgia': [
        ...
        'onset of severe, shooting, throbbing pain',
